                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control @error('code') is-invalid @enderror"
                            id="exampleInputUsername2" placeholder="Code" name="code" value="{{ old('code') }}">
                        @error('code')
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select
                            ...
                            @empty
                                <option value="RU">Data tidak ditemukan</option>
                            @endforelse
                        </select>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control @error('author') is-invalid @enderror"
                            id="exampleInputEmail2" placeholder="Author" name="author" value="{{ old( 'author') }}">
                        @error('author')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
