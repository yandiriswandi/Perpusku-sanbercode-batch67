                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="exampleInputEmail2"
                            placeholder="Name" name="name" value="{{ old('name', $category->name) }}" readonly>
                        @error('name')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea type="text" class="form-control" id="exampleInputMobile" placeholder="Description"
                            name="description" readonly>{{ old('description', $category->description) }}</textarea>
                    </div>
                </div>
                <hr>
                <h5>Books</h5>
                <div class="row"> {{-- gunakan g-4 untuk jarak antar kolom dan baris --}}
                    @forelse ($category->book as $item)
